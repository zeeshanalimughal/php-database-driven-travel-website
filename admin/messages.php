  ...
  <div class="container-fluid">
    <div class="row ">
      ...
      <div class="main min-vh-100 col-md-9  bg-white">
        ...
        <h1 class="display-5 text-center">Messages</h1>
        ...
        ?>
          <table class="table table-bordered">
            ...
            <tbody>
              <?php
              $selectUsers = "SELECT * from contact";
              ...
              ?>
                  <tr>
                    ...
                    <td><a href="deleteMessage.php?id=<?php echo $row['id'];  ?>" class="btn btn-outline-danger d-grid">Delete</a></td>
                  </tr>
              <?php
